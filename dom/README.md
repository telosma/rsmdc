...
RS DOM provides commonly-used utilities for inspecting, traversing, and manipulating the DOM.

Most of the time, you shouldn't need to depend on `rs-dom` directly. It is useful however if you'd like to write custom components that follow RS Web's pattern and elegantly integrate with the RS Web ecosystem.
