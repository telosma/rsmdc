...
import { getCorrectEventName, getCorrectPropertyName } from '@rsmdc/animation/util';
...
var RSSliderFoundation = /** @class */ (function (_super) {
    tslib_1.__extends(RSSliderFoundation, _super);
    function RSSliderFoundation(adapter) {
        var _this = _super.call(this, tslib_1.__assign({}, RSSliderFoundation.defaultAdapter, adapter)) || this;
        /**
    ...
    Object.defineProperty(RSSliderFoundation, "cssClasses", {
        get: function () {
            return cssClasses;
        },
        enumerable: true,
    ...
    Object.defineProperty(RSSliderFoundation, "strings", {
        get: function () {
            return strings;
        },
        enumerable: true,
    ...
    Object.defineProperty(RSSliderFoundation, "numbers", {
        get: function () {
            return numbers;
        },
        enumerable: true,
    ...
    Object.defineProperty(RSSliderFoundation, "defaultAdapter", {
        get: function () {
    ...
    RSSliderFoundation.prototype.init = function () {
        var _this = this;
    ...
    RSSliderFoundation.prototype.destroy = function () {
        var _this = this;
        DOWN_EVENTS.forEach(function (evtName) {
    ...
    RSSliderFoundation.prototype.setupTrackMarker = function () {
    ...
    RSSliderFoundation.prototype.layout = function () {
        this.rect_ = this.adapter_.computeBoundingRect();
        this.updateUIForCurrentValue_();
    };
    RSSliderFoundation.prototype.getValue = function () {
        return this.value_;
    };
    RSSliderFoundation.prototype.setValue = function (value) {
        this.setValue_(value, false);
    };
    RSSliderFoundation.prototype.getMax = function () {
        return this.max_;
    };
    RSSliderFoundation.prototype.setMax = function (max) {
        if (max < this.min_) {
    ...
    RSSliderFoundation.prototype.getMin = function () {
        return this.min_;
    };
    RSSliderFoundation.prototype.setMin = function (min) {
        if (min > this.max_) {
    ...
    RSSliderFoundation.prototype.getStep = function () {
        return this.step_;
    };
    RSSliderFoundation.prototype.setStep = function (step) {
        if (step < 0) {
    ...
    RSSliderFoundation.prototype.isDisabled = function () {
        return this.disabled_;
    };
    RSSliderFoundation.prototype.setDisabled = function (disabled) {
     ...
     */
    RSSliderFoundation.prototype.handleDown_ = function (downEvent) {
        var _this = this;
        if (this.disabled_) {
            return;
        }
     ...
     */
    RSSliderFoundation.prototype.handleMove_ = function (evt) {
        evt.preventDefault();
     ...
     */
    RSSliderFoundation.prototype.handleUp_ = function () {
     ...
     */
    RSSliderFoundation.prototype.getPageX_ = function (evt) {
     ...
     */
    RSSliderFoundation.prototype.setValueFromEvt_ = function (evt) {
     ...
     */
    RSSliderFoundation.prototype.computeValueFromPageX_ = function (pageX) {
     ...
     */
    RSSliderFoundation.prototype.handleKeydown_ = function (evt) {
     ...
     */
    RSSliderFoundation.prototype.getKeyId_ = function (kbdEvt) {
     ...
     */
    RSSliderFoundation.prototype.getValueForKeyId_ = function (keyId) {
    ...
    RSSliderFoundation.prototype.handleFocus_ = function () {
        if (this.preventFocusState_) {
            return;
        }
        this.adapter_.addClass(cssClasses.FOCUS);
    };
    RSSliderFoundation.prototype.handleBlur_ = function () {
     ...
     */
    RSSliderFoundation.prototype.setValue_ = function (value, shouldFireInput, force) {
     ...
     */
    RSSliderFoundation.prototype.quantize_ = function (value) {
        var numSteps = Math.round(value / this.step_);
        return numSteps * this.step_;
    };
    RSSliderFoundation.prototype.updateUIForCurrentValue_ = function () {
        var _this = this;
     ...
     */
    RSSliderFoundation.prototype.setActive_ = function (active) {
        this.active_ = active;
     ...
     */
    RSSliderFoundation.prototype.setInTransit_ = function (inTransit) {
     ...
     */
    RSSliderFoundation.prototype.toggleClass_ = function (className, shouldBePresent) {
        if (shouldBePresent) {
    ...
    return RSSliderFoundation;
}(RSFoundation));
export { RSSliderFoundation };
