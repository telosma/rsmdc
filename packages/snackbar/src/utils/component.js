...
import { RSSnackbarFoundation } from './foundation';
...
var RSSnackbar = /** @class */ (function (_super) {
    tslib_1.__extends(RSSnackbar, _super);
    function RSSnackbar() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RSSnackbar.attachTo = function (root) {
        return new RSSnackbar(root);
    };
    RSSnackbar.prototype.initialize = function (announcerFactory) {
        if (announcerFactory === void 0) { announcerFactory = function () { return util.announce; }; }
        this.announce_ = announcerFactory();
    };
    RSSnackbar.prototype.initialSyncWithDOM = function () {
        var _this = this;
    ...
    RSSnackbar.prototype.destroy = function () {
        _super.prototype.destroy.call(this);
        this.deregisterKeyDownHandler_(this.handleKeyDown_);
        this.deregisterSurfaceClickHandler_(this.handleSurfaceClick_);
    };
    RSSnackbar.prototype.open = function () {
     ...
     */
    RSSnackbar.prototype.close = function (reason) {
        if (reason === void 0) { reason = ''; }
        this.foundation_.close(reason);
    };
    RSSnackbar.prototype.getDefaultFoundation = function () {
        var _this = this;
        ...
        return new RSSnackbarFoundation(adapter);
    };
    Object.defineProperty(RSSnackbar.prototype, "timeoutMs", {
        get: function () {
    ...
    Object.defineProperty(RSSnackbar.prototype, "closeOnEscape", {
        get: function () {
    ...
    Object.defineProperty(RSSnackbar.prototype, "isOpen", {
        get: function () {
    ...
    Object.defineProperty(RSSnackbar.prototype, "labelText", {
        get: function () {
    ...
    Object.defineProperty(RSSnackbar.prototype, "actionButtonText", {
        get: function () {
    ...
    RSSnackbar.prototype.registerKeyDownHandler_ = function (handler) {
        this.listen('keydown', handler);
    };
    RSSnackbar.prototype.deregisterKeyDownHandler_ = function (handler) {
        this.unlisten('keydown', handler);
    };
    RSSnackbar.prototype.registerSurfaceClickHandler_ = function (handler) {
        this.surfaceEl_.addEventListener('click', handler);
    };
    RSSnackbar.prototype.deregisterSurfaceClickHandler_ = function (handler) {
        this.surfaceEl_.removeEventListener('click', handler);
    };
    RSSnackbar.prototype.isActionButton_ = function (target) {
        return Boolean(ponyfill.closest(target, ACTION_SELECTOR));
    };
    RSSnackbar.prototype.isActionIcon_ = function (target) {
